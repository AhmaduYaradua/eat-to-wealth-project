...
function Footer() {
  return (
    <div>
      <div className=" bg-black border-b-white  text-white">
        <div className="flex md:w-[90%] md:m-auto flex-col gap-3 md:flex-row items-center justify-between md:items-end px-[50px] py-[20px]">
